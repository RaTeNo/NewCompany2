	...
	<body>
		<div class="wrap">
			<div class="main">
				...
				<!-- Основная часть -->
				<section class="main_slider3 block bg white">
					<div class="slider owl-carousel">
						<div class="slide" style="background-image:url('images/tmp/slider5.jpg')">
							<div class="cont">
								...
								<div class="info">
									<div class="title">Торговая сеть у вашего дома с <span>лучшими</span> товарами</div>
				...
				<section class="upload block white bg no_margin">
